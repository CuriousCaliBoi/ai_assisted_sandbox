...
from cs336_systems.flash_attention import FlashAttention2PyTorchAutograd, FlashAttentionCuteAutograd
from cs336_systems.fsdp import FSDP, fsdp_gather_full_params
from cs336_systems.fsdp import fsdp_on_after_backward as _fsdp_on_after_backward_impl
...
def get_flashattention_autograd_function_pytorch() -> type:
    ...
    """
    return FlashAttention2PyTorchAutograd
...
def get_flashattention_autograd_function_triton() -> type:
    ...
    Returns:
        A class object (not an instance of the class)
    """
    # FA4 CuTeDSL kernels (forward + backward) on Blackwell/Hopper.
    return FlashAttentionCuteAutograd
...
def fsdp_on_after_backward(fsdp_model: torch.nn.Module, optimizer: torch.optim.Optimizer):
    ...
    _fsdp_on_after_backward_impl(fsdp_model, optimizer)
...
def fsdp_gather_full_params(fsdp_model: torch.nn.Module) -> dict[str, torch.Tensor]:
    ...
    """
    from cs336_systems import fsdp as fsdp_module

    return fsdp_module.fsdp_gather_full_params(fsdp_model)
